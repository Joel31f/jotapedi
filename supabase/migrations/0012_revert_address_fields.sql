-- =========================================================================
-- Reverte a consolidação de endereço da migration 0011: volta para campos
-- separados (rua, número, complemento, bairro, cidade, estado), mantendo
-- o CEP e as listas de emails/telefones como estão hoje.
-- =========================================================================
...
-- Preserva o que já tiver sido digitado no campo único "address" (sem tentar
-- adivinhar como separar em rua/número/bairro) para não perder nada.
...
-- Restaura o seed de demonstração usando os campos de cidade/estado separados
-- (a função tinha sido trocada na 0011 para usar a coluna única "address").
...
begin
  ...
  insert into public.clients (workspace_id, name, company, document, emails, phones, whatsapp, role_title, address_city, address_state, lead_stage, notes)
  values
